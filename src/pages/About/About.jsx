    ...
    <div className="about-page-container">
      ...
      <Container className="about-content">
        <div className="description">
          ...
          huerta y aprender programación.
        </p>
        <p>
        ...
        <p>
          Mi Huerta fue una excusa ideal para buscar recursos, aprender
          nuevas tecnologías, trabajar mucho y con ganas. Estoy convencida de
          que desarrollar Mi Huerta fue un proceso muy valioso.
...
<p>Este sitio fue realizado con información tomada del Planificador ProHuerta 2020 del INTA.</p>
